// Función para validar RUT (la misma que usamos para viajeros, ahora con validación de patrones comunes)
...
// Función para validar contraseña segura (la misma que usamos para viajeros)
...
document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("registroForm").addEventListener("submit", function(e) {
        ...
        // 3. Validar Organismo seleccionado
        if (organismo === "") {
            Swal.fire({
                icon: 'error',
                title: 'Campo Requerido',
                text: 'Por favor, seleccione un organismo.'
            });
        ...
        fetch("/funcionario/guardar", { // Asegúrate de que esta URL sea correcta para tu backend
            method: "POST",
            body: formData
        })
        .then(response => {
        ...
        .then(data => {
            Swal.fire({
                ...
                // Redirige al usuario a la página de login de funcionarios después de un registro exitoso
